...
public class Bootstrap implements ServiceLocator {
    ...
    private void initProjectsAndUsers() {
        ...
        final Project project1 = (Project) projectService.persistProject(user1.getId(), "Project1", "Description1", "20.02.2019", "20.05.2019");
        final Project project2 = (Project) projectService.persistProject(user2.getId(), "Project2", "Description2", "20.05.2019", "20.06.2019");
        final Project project3 = (Project) projectService.persistProject(user2.getId(), "Project1", "Description1", "20.02.2016", "20.05.2020");
