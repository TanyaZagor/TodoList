...
public class SessionEndpointService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.tm.zagorodnikova.ru/", "SessionEndpointService");
    public final static QName SessionEndpointPort = new QName("http://endpoint.tm.zagorodnikova.ru/", "SessionEndpointPort");
    static {
        URL url = null;
        try {
