...
public class UserEndpointService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.tm.zagorodnikova.ru/", "UserEndpointService");
    public final static QName UserEndpointPort = new QName("http://endpoint.tm.zagorodnikova.ru/", "UserEndpointPort");
    static {
        URL url = null;
        try {
    ...
    public IUserService getUserEndpointPort() {
        return super.getPort(UserEndpointPort, IUserService.class);
    }
     ...
     */
    @WebEndpoint(name = "UserEndpointPort")
    public IUserService getUserEndpointPort(WebServiceFeature... features) {
        return super.getPort(UserEndpointPort, IUserService.class, features);
    }
