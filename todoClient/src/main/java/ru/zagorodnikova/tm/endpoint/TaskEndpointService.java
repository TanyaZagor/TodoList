...
public class TaskEndpointService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.tm.zagorodnikova.ru/", "TaskEndpointService");
    public final static QName TaskEndpointPort = new QName("http://endpoint.tm.zagorodnikova.ru/", "TaskEndpointPort");
    static {
        URL url = null;
        try {
     ...
     *
     * @return
     *     returns ITaskService
     */
    @WebEndpoint(name = "TaskEndpointPort")
    public ITaskService getTaskEndpointPort() {
        return super.getPort(TaskEndpointPort, ITaskService.class);
    }
     ...
     */
    @WebEndpoint(name = "TaskEndpointPort")
    public ITaskService getTaskEndpointPort(WebServiceFeature... features) {
        return super.getPort(TaskEndpointPort, ITaskService.class, features);
    }
