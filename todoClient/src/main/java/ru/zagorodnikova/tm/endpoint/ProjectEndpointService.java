 ...
 * 2019-03-18T19:04:13.366+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "ProjectEndpointService",
                  wsdlLocation = "http://localhost:8080/ProjectEndpoint?wsdl",
                  targetNamespace = "http://endpoint.tm.zagorodnikova.ru/")
public class ProjectEndpointService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://endpoint.tm.zagorodnikova.ru/", "ProjectEndpointService");
    public final static QName ProjectEndpointPort = new QName("http://endpoint.tm.zagorodnikova.ru/", "ProjectEndpointPort");
    static {
        URL url = null;
        try {
     ...
     *
     * @return
     *     returns IProjectService
     */
    @WebEndpoint(name = "ProjectEndpointPort")
    public IProjectService getProjectEndpointPort() {
        return super.getPort(ProjectEndpointPort, IProjectService.class);
    }
     ...
     */
    @WebEndpoint(name = "ProjectEndpointPort")
    public IProjectService getProjectEndpointPort(WebServiceFeature... features) {
        return super.getPort(ProjectEndpointPort, IProjectService.class, features);
    }
