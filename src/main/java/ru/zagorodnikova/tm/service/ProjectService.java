...
public class ProjectService extends AbstractService implements IProjectService{
    ...
    @Nullable
    public Project persist(@NotNull String userId, @NotNull String projectName, @NotNull String description, @NotNull String dateStart, @NotNull String dateFinish){
    ...
    @Nullable
    public Project findOne(@NotNull String userId, @NotNull String projectName, @NotNull String projectDescription) {
    ...
    @Nullable
    public List<Project> sortByDateCreated(@NotNull String userId) {
    ...
    @Nullable
    public List<Project> sortByDateStart(@NotNull String userId) {
        @Nullable final List<Project> list = findAll(userId);
        if (list != null) {
    ...
    @Nullable
    public List<Project> sortByDateFinish(@NotNull String userId) {
        @Nullable final List<Project> list = findAll(userId);
        if (list != null) {
    ...
    @Nullable
    public List<Project> sortByStatus(@NotNull String userId) {
        @Nullable final List<Project> list = findAll(userId);
        if (list != null) {
